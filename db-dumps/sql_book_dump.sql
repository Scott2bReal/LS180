...
--
-- Name: addresses; Type: TABLE; Schema: public; Owner: scott
--
...
ALTER TABLE public.addresses OWNER TO scott;

--
-- Name: books; Type: TABLE; Schema: public; Owner: scott
--
...
ALTER TABLE public.books OWNER TO scott;

--
-- Name: books_id_seq; Type: SEQUENCE; Schema: public; Owner: scott
--
...
ALTER TABLE public.books_id_seq OWNER TO scott;

--
-- Name: books_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scott
--
...
--
-- Name: checkouts; Type: TABLE; Schema: public; Owner: scott
--
...
ALTER TABLE public.checkouts OWNER TO scott;

--
-- Name: checkouts_id_seq; Type: SEQUENCE; Schema: public; Owner: scott
--
...
ALTER TABLE public.checkouts_id_seq OWNER TO scott;

--
-- Name: checkouts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scott
--
...
--
-- Name: reviews; Type: TABLE; Schema: public; Owner: scott
--
...
ALTER TABLE public.reviews OWNER TO scott;

--
-- Name: reviews_id_seq; Type: SEQUENCE; Schema: public; Owner: scott
--
...
ALTER TABLE public.reviews_id_seq OWNER TO scott;

--
-- Name: reviews_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scott
--
...
--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: scott
--
...
ALTER TABLE public.users_id_seq OWNER TO scott;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scott
--
...
--
-- Name: books id; Type: DEFAULT; Schema: public; Owner: scott
--
...
--
-- Name: checkouts id; Type: DEFAULT; Schema: public; Owner: scott
--
...
--
-- Name: reviews id; Type: DEFAULT; Schema: public; Owner: scott
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: scott
--
...
--
-- Data for Name: addresses; Type: TABLE DATA; Schema: public; Owner: scott
--
...
--
-- Data for Name: books; Type: TABLE DATA; Schema: public; Owner: scott
--
...
3	My First SQL Book	Cary Flint	2015-10-18 14:05:44.547516	523120967812
\.


--
-- Data for Name: checkouts; Type: TABLE DATA; Schema: public; Owner: scott
--
...
--
-- Data for Name: reviews; Type: TABLE DATA; Schema: public; Owner: scott
--
...
1	John Smith	f	2022-05-05 22:22:40.830666
2	Alice Walker	t	2022-05-05 22:30:34.895784
3	Harry Potter	t	2022-05-05 22:30:34.895784
5	Jane Smith	t	2022-05-11 15:35:26.473939
\.


--
-- Name: books_id_seq; Type: SEQUENCE SET; Schema: public; Owner: scott
--
...
--
-- Name: checkouts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: scott
--
...
SELECT pg_catalog.setval('public.continents_id_seq', 1, false);


--
-- Name: reviews_id_seq; Type: SEQUENCE SET; Schema: public; Owner: scott
--
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: scott
--
...
--
-- Name: addresses addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: books books_isbn_key; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: books books_pkey; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: checkouts checkouts_pkey; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: reviews reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: users users_id_key; Type: CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: addresses addresses_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: checkouts checkouts_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: checkouts checkouts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scott
--
...
--
-- Name: reviews reviews_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scott
--
